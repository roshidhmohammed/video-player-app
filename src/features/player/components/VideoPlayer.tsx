...
import { handleSeekMouseUp } from "../services/seek";
    ...
    <AnimatePresence>
      {isOpen && (
        <motion.div
          ...
          animate={{ opacity: 1 }}
          exit={{ opacity: 0 }}
          className="fixed inset-0 z-50 w-full bg-[#1a1818]/50 backdrop-blur-md flex items-center justify-center p-4"
        >
          <motion.div
            ref={containerRef}
            drag="y"
            ...
            className="fixed top-0 left-0 w-full h-[100dvh] bg-black z-50 overflow-hidden shadow-2xl transform-gpu"
          >
            <div
